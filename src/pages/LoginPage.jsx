  ...
  return (
    <div className="min-h-screen bg-[#f0f0f0] flex items-center justify-center px-4">
      <div className="bg-white rounded-lg shadow-sm p-10 w-full max-w-sm">
        ...
        <Button variant="primary" size="full" className="mt-4" onClick={handleLogin}>
          로그인
        </Button>

        <p className="text-center text-sm text-gray-400 my-4">또는</p>

        <Button variant="kakao" size="full">
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            <ellipse cx="9" cy="8.5" rx="9" ry="8.5" fill="#3C1E1E" />
            <path d="M9 3C6.24 3 4 4.79 4 7c0 1.45.9 2.72 2.26 3.47L5.7 13l2.75-1.83C8.62 11.22 8.8 11.22 9 11.22c2.76 0 5-1.79 5-4.01C14 4.79 11.76 3 9 3z" fill="#FEE500" />
          </svg>
          카카오 로그인
        </Button>
